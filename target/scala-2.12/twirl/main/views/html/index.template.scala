...
/*9.2*/import views.html.IndexPage

/**/
class index @javax.inject.Inject() /*11.6*/(layout: Layout, content: IndexPage) extends _root_.play.twirl.api.BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,_root_.play.twirl.api.Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with _root_.play.twirl.api.Template5[String,String,String,Request[_$1] forSome { 
   type _$1
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: eeff074ffa815549cbf6db3516997dedca95b96d
                  MATRIX: 768->56|832->115|906->184|964->237|1041->273|1432->314|1609->422|1666->417|1697->449|1726->452|1800->517|1840->519|1873->526|1903->535
